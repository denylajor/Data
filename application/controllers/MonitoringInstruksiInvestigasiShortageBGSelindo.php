...
class MonitoringInstruksiInvestigasiShortageBGSelindo extends MY_Controller
{
    ...
    public function listMonitoringInstruksiInvestigasiShortageBGSelindo()
    {
        ...
        $list = $this->Serverside->_serverSide(
            ...
            ['no', 'Kantor_Cabang', 'Frekuensi', 'Nominal', 'Frekuensi_Kasus_New', 'Frekuensi_Kasus_Open', 'Frekuensi_Kasus_Close', 'Frekuensi_Kasus_∑', 'Closed_Case_Done', 'Closed_Case_Progress', 'Pending', 'Periode', 'user', 'tanggal_update'],
            ['Kantor_Cabang', 'Frekuensi', 'Nominal', 'Frekuensi_Kasus_New', 'Frekuensi_Kasus_Open', 'Frekuensi_Kasus_Close', 'Frekuensi_Kasus_∑', 'Closed_Case_Done', 'Closed_Case_Progress', 'Pending', 'Periode', 'user', 'tanggal_update'],
            ['user' => 'DESC'],
            null,
            'data'
        );
